...
async function getActivities(month = new Date().getMonth() + 1, year = new Date().getFullYear()) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$http$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(`Activity?month=${month}&year=${year}`).json();
...
//# sourceMappingURL=_29cebc07._.js.map